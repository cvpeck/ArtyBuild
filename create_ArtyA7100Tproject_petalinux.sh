...
petalinux-build
cd images/linux/
petalinux-package --boot --fsbl fs-boot.elf --u-boot u-boot.elf --mmi ../../../artytest.runs/impl_1/design_1_wrapper.mmi --fpga ../../../artytest.runs/impl_1/design_1_wrapper.bit
